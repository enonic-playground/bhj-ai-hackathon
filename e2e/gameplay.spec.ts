...
test.beforeEach(async ({ page }) => {
  ...
  // The journeys below are about movement, dots and key handling, so they run
  // the documented ball-free and enemy-free fixture: a legitimate capture or
  // death would otherwise freeze the maze mid-assertion. The M3 journeys in
  // `arcade.spec.ts`, and the production smoke, keep the real four enemies.
